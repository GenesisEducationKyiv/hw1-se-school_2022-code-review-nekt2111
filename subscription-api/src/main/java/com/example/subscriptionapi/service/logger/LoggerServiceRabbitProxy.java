package com.example.subscriptionapi.service.logger;

import com.example.subscriptionapi.model.logs.Log;
import com.example.subscriptionapi.model.logs.LogLevel;
...
public class LoggerServiceRabbitProxy implements LoggerService {
    ...
    private void sendLogToRabbit(String message, LogLevel logLevel) {
        Log log = new Log(message, logLevel, LocalDateTime.now(), "User API");
        String jsonLogStr = "";
        try {
