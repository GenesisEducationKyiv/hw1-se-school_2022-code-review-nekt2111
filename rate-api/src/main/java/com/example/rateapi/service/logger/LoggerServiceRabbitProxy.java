package com.example.rateapi.service.logger;

import com.example.rateapi.model.logs.Log;
import com.example.rateapi.model.logs.LogLevel;
...
public class LoggerServiceRabbitProxy implements LoggerService {
    ...
    private void sendLogToRabbit(String message, LogLevel logLevel) {
        Log log = new Log(message, logLevel, LocalDateTime.now(), "Rate API");
        String jsonLogStr = "";
        try {
